    ...
    <div class="rounded-xl border border-slate-200 bg-white p-4 shadow-sm">
        ...
        <form id="smtp-form" class="space-y-4">
            ...
            <div class="flex flex-wrap items-center gap-2">
                ...
                <button type="button" id="btn-smtp-validate" class="rounded-lg border border-slate-300 bg-white px-4 py-2 text-sm font-medium text-slate-800 hover:bg-slate-50">Validar conexao</button>
